<!-- Typing header with new titles -->
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=24&duration=2500&pause=800&color=00FFCC&center=true&vCenter=true&width=600&lines=Ibrahim+Chowdhury;Full+Stack+Developer;AI+Integrator+%F0%9F%A4%96;Generative+AI+Builder;DevOps+Practitioner;Building+Smart+%2B+Scalable+Apps" alt="Typing SVG" />
</div>
...
### ⚡ What I Bring
- 🤖 Integrate AI (text generation, image gen, chatbots) into real-world apps.
- 🚀 Deploy and manage full-stack apps with DevOps best practices.
- 🎯 Write clean, maintainable code accelerated by AI co‑pilots.
- 🌐 Build responsive, scalable frontends with React/Next.js & Tailwind.
